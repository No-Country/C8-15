...
public class BuyerRequestPassword {
    ...
    @NotBlank(message = "EL PASSWORD ANTERIOR DEL COMPRADOR NO PUEDE ESTAR VACÍO O SER NULO")
    ...
    @NotBlank(message = "EL PASSWORD DEL COMPRADOR NO PUEDE ESTAR VACÍO O SER NULO")
    ...
    @NotBlank(message = "LA CONFIRMACIÓN DEL PASSWORD DEL COMPRADOR NO PUEDE ESTAR VACÍO O SER NULO")
